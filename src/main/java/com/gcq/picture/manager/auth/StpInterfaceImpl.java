...
import static com.gcq.picture.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    @Resource
    private SpaceUserManager spaceUserAuthManager;
    ...
    private SpaceUserAuthContext getSpaceUserAuthContext() {
       ...
       //兼容 get 和 post
        if(ContentType.JSON.getValue().equals(header)){
            ...
            spaceUserAuthContext = JSON.parseObject(body, SpaceUserAuthContext.class);
        } else {
